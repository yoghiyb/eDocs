        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img v-if="$root.$data.authUser && $root.$data.authUser.photo" :src="[$root.$data.authUser.photo == 'profile.png' ? '/img/'+$root.$data.authUser.photo : '/storage/images/' + $root.$data.authUser.photo]" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
